...
import { HomeScreensEnum, IHomeSolution } from 'widgets/01-home-screens/lib/types';
import css from './solutions.module.scss';
import { Player } from '@lottiefiles/react-lottie-player';

const Solutions: React.FC = () => {
    const solutions = useTranslationObject<IHomeSolution[]>('solutions.list', 'home');
                        ...
                        children={
                            <div className={css.solution}>
                                ...
                                <h2 
                                    className={css.title}
                                >
                                    <span>{activeSolution.title_short}</span> – {activeSolution.extraTitle} 
                                </h2>
                                ...
                                >
                                    ...
                                    <h4 className={css.list_title}>
                                        ...
                                        <MediaQuery 
                                            ...
                                            children={<><span>{solution.title_short}</span> – {solution.extraTitle}</>}
                                        />
                                    </h4>
